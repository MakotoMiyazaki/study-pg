...

{
	...
	stage.addItem(new Item(new Position(2, 3), ITEM_TYPE.own, directionType.north));
	stage.addItem(new Item(new Position(2, 0), ITEM_TYPE.redWall));
	stage.addItem(new Item(new Position(2, 5), ITEM_TYPE.goal));
	stageController.addStage(stage);
}

{
	var stage = new Stage(cellType.middle);
	stage.addItem(new Item(new Position(0, 3), ITEM_TYPE.own, directionType.north));
	stage.addItem(new Item(new Position(0, 0), ITEM_TYPE.redWall));
	stage.addItem(new Item(new Position(6, 1), ITEM_TYPE.blueWall));
	stage.addItem(new Item(new Position(5, 6), ITEM_TYPE.goal));
	stageController.addStage(stage);
}
